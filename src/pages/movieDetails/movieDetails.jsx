    ...
    return (
        <div className={styles.movieDetails}>
            <div className={styles.movieDetailsPoster}>
                ...
                <p className={styles.movieDetailsRating}>{movie?.Rating}</p>
                <p className={styles.movieDetailsGenres}>{movie?.Genres}</p>
                <p className={styles.movieDetailsCast}>{movie?.Cast}</p>
            </div>
        </div>
    )
}